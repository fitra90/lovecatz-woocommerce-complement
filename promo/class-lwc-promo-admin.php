...
class LWC_Promo_Admin {
	...
	private function is_valid_coupon_post( $coupon_id ) { if ( ! $coupon_id ) { return false; } $post = get_post( $coupon_id ); return $post instanceof WP_Post && 'shop_coupon' === $post->post_type; }
