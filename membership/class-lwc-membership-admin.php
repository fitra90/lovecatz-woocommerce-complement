...
class LWC_Membership_Admin {
    ...
    public function enqueue_admin_assets( $hook ) {
        ...
        wp_enqueue_style( 'lwc-admin-settings', LWC_PLUGIN_URL . 'membership/assets/admin-settings.css', array(), LWC_VERSION );
        wp_enqueue_script( 'lwc-admin-settings', LWC_PLUGIN_URL . 'membership/assets/admin-settings.js', array( 'jquery' ), LWC_VERSION, true );
    }
